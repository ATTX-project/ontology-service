import click
import unittest
from onto.app import init_api
from click.testing import CliRunner
from onto.applib.messaging import ScalableRpcServer
from onto.ontoservice import ONTOService, number_of_workers, main, rpc
...
class TestAPIStart(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.app = ONTOService(init_api(), options)
